...
/*
|--------------------------------------------------------------------------
| WCP PORTAL SHORTCUT REDIRECTS
|--------------------------------------------------------------------------
|
| Public shortcut URLs on wcpwireless.com redirect directly to the WCP
| portal before WordPress loads a page template or the 404 template.
|
| Matching is case-insensitive and ignores leading/trailing slashes.
| Destination capitalization and URL fragments are preserved exactly below.
|
*/

function wcp_portal_shortcut_redirects() {
    ...
    $portal_redirects = array(
        ...
        'magnacorp' =>
            'https://portal.wcpwireless.com/magnacorp',
    );

    if (!isset($portal_redirects[$request_key])) {
        return;
    }
