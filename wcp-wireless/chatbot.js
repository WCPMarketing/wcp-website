  ...
  panel.innerHTML =
    ...
    '<div class="wcp-chat-header">' +
      ...
      '<div>' +
        ...
        '<div class="wcp-chat-header-title">' +
          'Bob' +
        '</div>' +

        '<div class="wcp-chat-header-sub">' +
          'WCP Assistant · Rogers Authorized Dealer' +
        '</div>' +

      '</div>' +

      '<button class="wcp-chat-close" aria-label="Close chat">' +
